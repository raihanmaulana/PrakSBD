...
<a href="{{ route('konter_hp.create') }}" type="button" class="btn btn-success rounded-3">Tambah Data</a>
...
<table class="table table-hover mt-2">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('konter_hp.edit', $data->id_toko) }}" type="button" class="btn btn-warning rounded-3">Ubah</a>
                ...
                <div class="modal fade" id="hapusModal{{ $data->id_toko }}" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('konter_hp.delete', $data->id_toko) }}">
                                @csrf
                                <div class="modal-body">
                                    Apakah anda yakin ingin menghapus data ke {{$data->id_karyawan}}?
                                </div>
